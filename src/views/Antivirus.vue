  ...
  export default {
    data() {
      return {
        ...
        deniedDataTable: [],
        deniedHeader: [
            { title: 'Threat Level', key: 'REMIP' },
            { title: 'Source IP', key: 'REASON' },
            { title: 'Destination IP', key: 'REASON' },
            { title: 'Victim User', key: 'L_DATE' },
            { title: 'Virus', key: 'LOGDESC' },
            { title: 'Incidents', key: 'REASON' },
        ],
    };
    },
    methods: {
